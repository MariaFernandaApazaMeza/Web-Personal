...
<body>
  ...
  <section id="cursos-universitarios">
    ...
    <div class="grid">
      ...
      <p> class="section-text>
      Docente: Karlo Alfonso Lam Obregón
      <a href="https://www.linkedin.com/in/karlolam?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app"target="_blank" style="color:#000; font-weight:bold; text-decoration:underline;">Linkedln</a></p>
      </div>
